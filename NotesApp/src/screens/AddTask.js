...
import dateTimeHelper from '../configs/datetimeHelper';
...
export default class AddTask extends Component{
    constructor(props)
    {
        ...
        this.state = {
            ...
            taskTime:Moment(Date().getTime).format("h:mm A"),
        }
    }
    componentDidMount(){
    ...
    static navigationOptions=({navigation})=>{
        return{
            title:localizedString.add_task_header,
            headerStyle:{
        ...
        return(
            <View>
                <View style={styles.taskView}>
                    <Text>Task</Text>
                    <TextInput onChangeText={(value) => this.setState({ Description: value })} style={styles.textView} placeholder='enter new task'/>
            ...
            <View style={{flexDirection:'row',}}>
                <TouchableOpacity onPress={this.clickOnSave} style={styles.button}> 
                    <View >
